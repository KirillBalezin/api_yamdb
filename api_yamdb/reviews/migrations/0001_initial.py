# Generated by Django 3.2 on 2023-03-18 11:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(related_name='titles', through='reviews.GenresTitles', to='reviews.Genres', verbose_name='Жанр')),
            ],
            options={
